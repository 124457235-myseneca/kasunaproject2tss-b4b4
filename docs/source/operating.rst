[kasunaproject2tss-b4b4] Operating Details
====================================

Generated On: 2024-10-31 14:25:29 UTC
...
.. important::
   ...
   **not be valid if your [kasunaproject2tss-b4b4] container is NOT running**.

.. tip::
   You must have your [kasunaproject2tss-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43129  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/kasunaproject2tss-b4b4-amd64 (https://hub.docker.com/r/kasunsam/kasunaproject2tss-b4b4-amd64)
...
.. important::
   docker run -d -p 34417:34417 -p 46937:46937 -p 60787:60787 \-\-env TSS=0 \-\-env SOLUTIONNAME=kasunaproject2tss-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-kasunaproject2tss-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=34417  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=46937  \-\-env SOLUTIONVIPERVIZPORT=60787 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=43129 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/kasunaproject2tss-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=60787
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=34417
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/kasunaproject2tss-b4b4-amd64
...
It can be accessed by entering: http://localhost:46937
...
.. important::
   http://localhost:60787/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:60787/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:60787/<html file>
...
[kasunaproject2tss-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/kasunaproject2tss-b4b4
...
.. important::
   https://kasunaproject2tss-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-kasunaproject2tss-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=34417, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36863, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33737, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35007, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33525, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36055, HPDEHOST=127.0.1.1, HPDEPORT=44299, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35331

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4573-kasunaproject2tss-b4b4,solution_preprocessing_dag-kasunaproject2tss-b4b4, python-preprocess-8433-kasunaproject2tss-b4b4,solution_preprocessing_dag-kasunaproject2tss-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
